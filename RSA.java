    ...
    public static void main(String[] args) throws IllegalBlockSizeException, InvalidKeyException, NoSuchPaddingException, BadPaddingException {
        ...
        static void  KB(){
        	...
        	try{
        		 ...
        		 String originalString_kb="CSE439";
        		 System.out.println("RSA 500 kb");
        		 long startTime_E = System.currentTimeMillis();
        		 long total_E = 0; 
        		 String encryptedString = Base64.getEncoder().encodeToString(encrypt(originalString_kb, publicKey));
